"""
Code adapted from the DNABERT2 implementation with small modifications.
"""
...
def train():
    ...
    os.environ["WANDB_PROJECT"] = "DNABERT"  # name your W&B project
    ...
    # define trainer
    trainer = transformers.Trainer(model=model.to("cpu"),
                                   tokenizer=tokenizer,
                                   args=training_args,
